...
typedef NTSTATUS(WINAPI *ZwQueryObject)(HANDLE h, INT /*OBJECT_INFORMATION_CLASS*/ oic, PVOID ObjectInformation, ULONG ObjectInformationLength, PULONG ReturnLength);
...
typedef NTSTATUS(WINAPI *NTOPENDIRECTORYOBJECT)(PHANDLE DirectoryHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes);
